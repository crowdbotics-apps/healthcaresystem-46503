"""
Django settings for healthcaresystem_46503 project.
...
ROOT_URLCONF = 'healthcaresystem_46503.urls'
...
WSGI_APPLICATION = 'healthcaresystem_46503.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthcaresystem_46503 API",
    "DESCRIPTION": "API documentation for healthcaresystem_46503 App",
    "VERSION": "v1",
}
